...
2. reads at most one SQL VALUES chunk;
3. validates row width and converts cells to owned `FastParameter` values;
4. releases the GIL;
5. sends and fully drains that chunk before converting the next one.
