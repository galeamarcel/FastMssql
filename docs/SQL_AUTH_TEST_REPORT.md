...
- Machine: `arm64`
- Git commit: `5dc70031fc1961faf76a5ec1fdb6f28b1141c10b`
...
| `FRAME-009` | {"concurrent_seconds": 1.018155583878979, "ratio": 0.25164005493061403, "sequential_seconds": 4.046079167164862} |
| `FRAME-010` | {"ticker_count": 47} |
| `FRAME-011` | {"cancellation_seconds": 0.0002647917717695236, "pool_after": {"active_connections": 0, "connected": true, "connections": 1, "idle_connections": 1, "max_size": 4, "min_idle": 0}} |
| `FRAME-015` | {"distinct_request_loops": true, "loop_ids": [4483187680, 4483192240]} |
| `FRAME-016` | {"concurrent": [0, 1, 2, 3], "concurrent_seconds": 1.0217076251283288, "sequential": [0, 1, 2, 3], "sequential_seconds": 4.044092916185036} |
| `FRAME-017` | {"elapsed_seconds": 2.0281440000981092, "execution_model": "WSGI worker-bound", "requests": 4} |
| `FRAME-021` | {"loop_id": 4483201664, "persistent_loop": true} |
| `FRAME-022` | {"elapsed_seconds": 8.036415999988094, "execution_model": "persistent ASGI loop around Flask/WSGI", "requests": 4} |
| `FRAME-023` | {"cancellation_seconds": 0.00036225002259016037, "pool_after": {"active_connections": 0, "connected": true, "connections": 1, "idle_connections": 1, "max_size": 4, "min_idle": 0}, "recovery_bound_seconds": 3.5} |

## Load metrics

| Case | Metrics |
|---|---|
| `LOAD-001` | {"elapsed_seconds": 0.22799595911055803, "queries_per_second": 4386.0426469887025} |
| `LOAD-002` | {"python_current_bytes": 1592592, "python_peak_bytes": 4793748, "rss_after_bytes": 80953344, "rss_before_bytes": 58867712} |
...
| `LOAD-004` | {"elapsed_by_size": {"1": 0.009230541065335274, "100": 0.009732875041663647, "1000": 0.11380258412100375, "10000": 0.34144124994054437}} |
| `LOAD-005` | {"baseline_sessions": 0, "elapsed_seconds": 1.7435164169874042, "final_sessions": 0} |
| `LOAD-006` | {"elapsed_seconds": 0.3230183750856668, "operation_count": 500} |
| `LOAD-008` | {"concurrency": 50, "distinct_session_count": 38, "elapsed_seconds": 1.5752435000613332, "transaction_count": 1000, "transactions_per_second": 634.8224893237549} |
| `LOAD-009` | {"elapsed_seconds": 0.1682520410977304, "peak_observed_sessions": 20, "pool_max_size": 20, "probe_count": 1000, "probes_per_second": 5943.464301982184, "task_concurrency": 100} |
