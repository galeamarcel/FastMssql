...
- Machine: `arm64`
- Git commit: `5936cb5d6c6f1e7fd55e4d70fb28143cdbc7fd7a`
...
| compose-up | 0 | 0 | 0 | 0 | 0 | docker compose --env-file /Users/marcelgalea/Developer/fast_mssql_testdev/FastMssql/.worktrees/verify-observability-metrics/.env.sql-auth.local -f docker-compose.sql-auth.yml up -d sqlserver |
...
| `FRAME-009` | {"concurrent_seconds": 1.022113291081041, "ratio": 0.2522508433367722, "sequential_seconds": 4.051971749868244} |
| `FRAME-010` | {"ticker_count": 47} |
| `FRAME-011` | {"cancellation_seconds": 0.00025279191322624683, "pool_after": {"active_connections": 0, "connected": true, "connections": 1, "connections_closed_broken": 1, "connections_closed_idle_timeout": 0, "connections_closed_invalid": 0, "connections_closed_max_lifetime": 0, "connections_created": 2, "get_direct": 1, "get_started": 3, "get_timed_out": 0, "get_wait_time_seconds": 0.012552, "get_waited": 2, "idle_connections": 1, "max_size": 4, "min_idle": 0, "pending_gets": 0}} |
| `FRAME-015` | {"distinct_request_loops": true, "loop_ids": [4515291840, 4515286064]} |
| `FRAME-016` | {"concurrent": [0, 1, 2, 3], "concurrent_seconds": 1.0204397500492632, "sequential": [0, 1, 2, 3], "sequential_seconds": 4.033804708858952} |
| `FRAME-017` | {"elapsed_seconds": 2.0243319168221205, "execution_model": "WSGI worker-bound", "requests": 4} |
| `FRAME-021` | {"loop_id": 4515290016, "persistent_loop": true} |
| `FRAME-022` | {"elapsed_seconds": 8.035381582798436, "execution_model": "persistent ASGI loop around Flask/WSGI", "requests": 4} |
| `FRAME-023` | {"cancellation_seconds": 0.0004967499990016222, "pool_after": {"active_connections": 0, "connected": true, "connections": 1, "connections_closed_broken": 1, "connections_closed_idle_timeout": 0, "connections_closed_invalid": 0, "connections_closed_max_lifetime": 0, "connections_created": 2, "get_direct": 1, "get_started": 3, "get_timed_out": 0, "get_wait_time_seconds": 0.017655, "get_waited": 2, "idle_connections": 1, "max_size": 4, "min_idle": 0, "pending_gets": 0}, "recovery_bound_seconds": 3.5} |

## Load metrics

| Case | Metrics |
|---|---|
| `LOAD-001` | {"elapsed_seconds": 0.243680665967986, "queries_per_second": 4103.731397924597} |
| `LOAD-002` | {"python_current_bytes": 1592592, "python_peak_bytes": 4793748, "rss_after_bytes": 84525056, "rss_before_bytes": 63881216} |
...
| `LOAD-004` | {"elapsed_by_size": {"1": 0.009392374893650413, "100": 0.008662833133712411, "1000": 0.11254720808938146, "10000": 0.3416108749806881}} |
| `LOAD-005` | {"baseline_sessions": 0, "elapsed_seconds": 1.6559284590184689, "final_sessions": 0} |
| `LOAD-006` | {"elapsed_seconds": 0.31828737491741776, "operation_count": 500} |
| `LOAD-008` | {"concurrency": 50, "distinct_session_count": 36, "elapsed_seconds": 1.4207491248380393, "transaction_count": 1000, "transactions_per_second": 703.8540320156782} |
| `LOAD-009` | {"elapsed_seconds": 0.14529687515459955, "peak_observed_sessions": 20, "pool_max_size": 20, "probe_count": 1000, "probes_per_second": 6882.460472298353, "task_concurrency": 100} |
| `OBS-009` | {"elapsed_seconds": 1.3471100409515202, "event_loop_ticks": 36715, "max_pending_gets": 100, "operation_count": 10000, "physical_connections": 20, "pool_max_size": 20, "queries_per_second": 7423.298539840577, "scrape_samples": 9216, "worker_count": 100} |
