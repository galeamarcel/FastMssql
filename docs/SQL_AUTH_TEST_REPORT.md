...
- Machine: `arm64`
- Git commit: `0782590096ba2e548ea565b1339617a108033578`
...
| `FRAME-009` | {"concurrent_seconds": 1.0120451669208705, "ratio": 0.25102715222474076, "sequential_seconds": 4.031616332940757} |
| `FRAME-010` | {"ticker_count": 47} |
| `FRAME-011` | {"cancellation_seconds": 0.00028833397664129734, "pool_after": {"active_connections": 0, "connected": true, "connections": 1, "idle_connections": 1, "max_size": 4, "min_idle": 0}} |
| `FRAME-015` | {"distinct_request_loops": true, "loop_ids": [4474200464, 4474201376]} |
| `FRAME-016` | {"concurrent": [0, 1, 2, 3], "concurrent_seconds": 1.0223972501698881, "sequential": [0, 1, 2, 3], "sequential_seconds": 4.038975999923423} |
| `FRAME-017` | {"elapsed_seconds": 2.021951416041702, "execution_model": "WSGI worker-bound", "requests": 4} |
| `FRAME-021` | {"loop_id": 4474200160, "persistent_loop": true} |
| `FRAME-022` | {"elapsed_seconds": 8.025876499945298, "execution_model": "persistent ASGI loop around Flask/WSGI", "requests": 4} |
| `FRAME-023` | {"cancellation_seconds": 0.0002327500842511654, "pool_after": {"active_connections": 0, "connected": true, "connections": 1, "idle_connections": 1, "max_size": 4, "min_idle": 0}, "recovery_bound_seconds": 3.5} |

## Load metrics

| Case | Metrics |
|---|---|
| `LOAD-001` | {"elapsed_seconds": 0.20439108298160136, "queries_per_second": 4892.581346564991} |
| `LOAD-002` | {"python_current_bytes": 1592592, "python_peak_bytes": 4793748, "rss_after_bytes": 86081536, "rss_before_bytes": 63406080} |
...
| `LOAD-004` | {"elapsed_by_size": {"1": 0.010150874964892864, "100": 0.008486875100061297, "1000": 0.12588179111480713, "10000": 0.3567282499279827}} |
| `LOAD-005` | {"baseline_sessions": 0, "elapsed_seconds": 1.750498249894008, "final_sessions": 0} |
| `LOAD-006` | {"elapsed_seconds": 0.33825745806097984, "operation_count": 500} |
| `LOAD-008` | {"concurrency": 50, "distinct_session_count": 35, "elapsed_seconds": 1.554837874835357, "transaction_count": 1000, "transactions_per_second": 643.1538723006029} |
| `LOAD-009` | {"elapsed_seconds": 0.14771429193206131, "peak_observed_sessions": 20, "pool_max_size": 20, "probe_count": 1000, "probes_per_second": 6769.825633798069, "task_concurrency": 100} |
